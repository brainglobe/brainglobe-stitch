...
class Overlap:
    ...
    def linear_interpolation(
        ...
        """
        Perform linear interpolation on the overlapping data for both tiles.

        Parameters
        ----------
        resolution_level: int
            The resolution level to perform the interpolation on.
        tile_shape: Tuple[int, ...]
            The shape of the tile data at the given resolution level.
        """
